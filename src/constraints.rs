...
//     use ark_mnt4_298::{constraints::PairingVar as MNT4PairingVar, Fr as
// MNT4Fr, MNT4_298 as MNT4};     use ark_mnt6_298::Fr as MNT6Fr;
//     use ark_r1cs_std::{alloc::AllocVar, bits::boolean::Boolean,
// eq::EqGadget};     use ark_relations::{
//         lc, ns,
...
//     }
//
//     impl<ConstraintF: Field> ConstraintSynthesizer<ConstraintF> for
// Circuit<ConstraintF> {         fn generate_constraints(
//             self,
...
//         };
//
//         let (pk, vk) = TestSNARK::circuit_specific_setup(circ, &mut
// rng).unwrap();
//
...
//         )
//         .unwrap();
//         TestSNARKGadget::verify_with_processed_vk(&pvk_gadget, &input_gadget,
// &proof_gadget)             .unwrap()
//             .enforce_equal(&Boolean::constant(true))
//             .unwrap();
//
